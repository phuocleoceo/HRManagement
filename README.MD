...
<p align="center">
  <p>
    <img src="https://d33wubrfki0l68.cloudfront.net/4205d0600846259a187789ac358b9107a308d949/a4ec6/img/logo.svg" alt="Logo" style="display: block; margin-left: auto; margin-right: auto; width:50%">
  </p>
...
<!-- ABOUT THE PROJECT -->
## About The Project
A simple app to learn about ASP.NET Web API 5.0 and ReactJS

Benefits:
* Bootstrap UI.
* Easy to use.
* Apply newest technology
...
2. Clone the repo
   ...
   ```
3. Open with Visual Studio Code, change directory to WebAPI and run: 
   ```
   dotnet run
   ```
4. Change API_URL in client-app/src/api/apiService.js and run:
   ```sh
    npm i
   ```
5.  Change directory to client-app and run: 
	```sh
    npm start
   ```
...
See the [open issues](https://github.com/phuocleoceo/HRManagement) for a list of proposed features (and known issues).
